...
static const UInt8 ulaw_to_alaw_table[256] = {
...
static const UInt8 alaw_to_ulaw_table[256] = {
   42,  43,  40,  41,  46,  47,  44,  45,  34,  35,  32,  33,  38,  39,  36,
...
UInt8 alaw_to_ulaw(UInt8 alaw) { return alaw_to_ulaw_table[alaw]; }

UInt8 ulaw_to_alaw(UInt8 ulaw) { return ulaw_to_alaw_table[ulaw]; }
